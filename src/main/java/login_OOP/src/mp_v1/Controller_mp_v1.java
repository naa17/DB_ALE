    ...
    public class Controller_mp_v1 {
                ...
                if(filled==1)
                {
                        ...
                        try {
                            if (login_OOP.src.mp_v1.Login.getLogin()){
                                ...
                                URL url2 = new File("/Users/admin/Documents/Java/group_project/DB_ALE/src/main/java/simple_logbook/src/sample/lb_v1_2.fxml").toURI().toURL();
        ...
        public void regButton(ActionEvent actionEvent) throws Exception{
            ...
            if (getRegister()) {
                ...
                URL url1 = new File("/Users/admin/Documents/Java/group_project/DB_ALE/src/main/java/registrationFX/src/sample/registration.fxml").toURI().toURL();
